...
from application.recipes.models import FavoriteCartDB, RecipeDB
from application.recipes.schemas import FavoriteOut
...
async def delete_cart_favorite(
    pk: int, user: User, db_model: Any, session: AsyncSession
) -> JSONResponse:
